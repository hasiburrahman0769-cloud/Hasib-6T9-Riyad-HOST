...
@app.route('/')
def home():
    return f"<h1>ㅤHꫝsɪʙㅤ6T9 & RIYAD Hosting Test Server</h1><p>Running at {time.ctime()}</p>"
...
def login():
    ...
    <body>
        ...
        <div class="login-container">
            <div class="logo">ㅤHꫝsɪʙㅤ6T9 & RIYAD Hosting</div>
...
if __name__ == "__main__":
    ...
    print(f"""
    ╔══════════════════════════════════════════╗
    ║      ㅤHꫝsɪʙㅤ6T9 - RIYAD Hosting - Unlimited Servers    ║
